...
public class TokenUtils {
    ...
    // Period vazenja tokena - 3000 minuta
    @Value("180000000")
     ...
     *
     *  username Korisničko ime korisnika kojem se token izdaje
     * @return JWT token
     */
    public String generateToken(User user) {
        return Jwts.builder().claim("id", user.getId()).claim("type","Bearer").claim("email", user.getEmail())
                .setIssuer(APP_NAME)
